      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="client_leave.jsp"> <i class="icon-grid"></i>Leave </a></li>
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="block">
                  ...
                  <input type="hidden" name="dept_id" value="<%=emp.getDept_id()%>">
                  <input type="hidden" name="emp_id" value="<%=emp.getEmp_id()%>">
                    <div class="form-group">
                      <input type="text" class="form-control" placeholder="Enter Title" name="title" style="border-top-right-radius: 20px; border-bottom-left-radius: 20px">
                    </div>
                    <div class="form-group">
                      <textarea class="form-control" rows="3" placeholder="Enter Message" name="description" style="border-top-right-radius: 20px; border-bottom-left-radius: 20px"></textarea>
                    </div>
                    
                    <div class="form-group">
                <div class='input-group date' id='datetimepicker1'>
                    <input type='date' class="form-control" name="start" style="border-top-right-radius: 20px; border-bottom-left-radius: 20px"/>
                ...
                <div class="form-group">
                <div class='input-group date' id='datetimepicker1'>
                    <input type='date' class="form-control" name="end" style="border-top-right-radius: 20px; border-bottom-left-radius: 20px" />
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                    </span>
                  </div>
                    </div>
                  ...
                  <div class="form-group col-lg-12"><center>
                    <input class="form-control btn btn-success center-block" type="submit" value="Submit"></center>
                  </div>
                  </form>
                </div>
            </div>
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-sm-6 text-right">
                  <p>Design & Developed by Akash Rupareliya & Sugnay Borsaniya</p>
