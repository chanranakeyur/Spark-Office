      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Delete Department</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
              ...
              <div class="row">
              	  ...
              	  <div class="input-group">
           			<form action="CompanyController" method="POST" class="form-control">
                  		<input type="number" name="dept_id" class="form-control" placeholder="Enter Department Id"><span class="input-group-btn">
                    	<input type="submit" name="deptDelete" value="Delete" class="btn btn-secoundry"></span>
                  	</form>
               	  </div>
           </div>
           </div>
