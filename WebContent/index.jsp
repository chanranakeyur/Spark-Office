...
<%
	...
	long empCount = impl.Count(comp_id,"EmployeeEntity");
	long deptCount = impl.Count(comp_id,"DeptEntity");
 	long noticeCount = impl.Count(comp_id,"NoticeEntity");
	long leaveCount = impl.Count(comp_id,"LeaveEntity");
%>
    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="showallemp.jsp" class="sidebar-link text-muted"><i class="o-table-content-1 mr-3 text-gray"></i><span>Employee</span></a></li>
        ...
        <div class="container-fluid px-xl-5">
          <section class="py-5">
            <div class="row">
              ...
              <a href="showallemp.jsp" style="text-decoration:none">
                <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
                  <div class="flex-grow-1 d-flex align-items-center">
                    <div class="dot mr-3 bg-violet"></div>
                    <div class="text">
                      <h6 class="mb-0">Employees</h6><span class="text-gray"> <% out.println("<b>" + empCount + "</b>"); %></span>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
                <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
                  <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <div class="text">
                      <h6 class="mb-0">Departments</h6><span class="text-gray"><% out.println("<b>" + deptCount + "</b>"); %></span>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
                <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
                  <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <div class="text">
                      <h6 class="mb-0">leave status</h6><span class="text-gray"><% out.println("<b>" + leaveCount + "</b>"); %></span>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
                <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
                  <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <div class="text">
                      <h6 class="mb-0">Notice</h6><span class="text-gray"><% out.println("<b>" + noticeCount + "</b>"); %></span>
                    </div>
                  </div>
