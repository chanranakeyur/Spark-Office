...
<html>
  <head>
    ...
    <!-- Tweaks for older IEs--><!--[if lt IE 9]>
 	...
 	function pass()
  	{
  		if(form.comp_confpassword.value != form.comp_password.value)
	  	{
...
<form method="post" action="RegisterServlet" name="form">
	 ...
	 <div class="form-group">
      ...
      <input class="btn btn-lg btn-success1 btn-block" type="submit" class="input-material" value="Submit" onclick="return pass();">
