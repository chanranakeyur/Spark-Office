      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
         ...
         <form action="CompanyController" method="POST">            
            ...
            <b>Update Department ID:</b> <input type="number" name="dept_id" class="input-material" value="${deptList.dept_id}" readonly><br>
            </div>
            <div class="form-group">
            <b>Update Department Name:</b> <input id="dept_name" type="text" name="dept_name" class="input-material" value="${deptList.dept_name}"><br>
            </div>
            <input type="submit" name="updateDept" value="updateDept" class="btn btn-primary">
        </c:forEach>
        </form>
            </div>
                    </div>
